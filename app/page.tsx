    ...
    <>
      ...
      <JsonLd
        data={[
          jsonLdPerson(),
          jsonLdWebSite(),
          jsonLdBreadcrumb([{ name: "Home", path: "/" }]),
        ]}
      />
      ...
      <div className="space-y-16">
          ...
          <div className="space-y-6 lg:col-span-7">
            ...
            <div className="grid gap-4 sm:grid-cols-2 sm:grid-rows-2">
              ...
              <div className="h-full rounded-2xl border border-neutral-200 bg-white p-5 sm:row-span-2">
                ...
                <div className="mt-1 text-sm leading-relaxed text-neutral-700">
                  <p>
                    I work confidently in multilingual environments and support
                    international teams and projects. I also hold speaker
                    assignments at events and conferences in these languages.
                  </p>
                  <ul className="mt-3 list-disc space-y-1 pl-6">
                    ...
                    <li>
                      <strong>Working knowledge:</strong> Spanish, Portuguese,
                      Italian. Comprehension for analytics, SEO and campaign
                      review.
                    </li>
                  </ul>
                </div>
              ...
              <div className="h-full rounded-2xl border border-neutral-200 bg-white p-5">
                ...
                <div className="mt-1 text-sm leading-relaxed text-neutral-700">
                  Strong experience across consumer brands, eCommerce, B2B SaaS,
                  lead-driven businesses and international non-profit
                  organisations.
                </div>
              </div>
            </div>
        ...
        <section className="max-w-3xl space-y-6">
          ...
          <div className="space-y-4 leading-relaxed text-neutral-700">
            <p>
              I’m Lisa, a freelance Web Analytics consultant specialising in
              reliable tracking and measurement architectures. I work hands-on
              across GA4, GTM, BigQuery and Looker Studio. I help freelancers,
              startups and small to medium-sized businesses improve attribution,
              data quality and decision-making.
            </p>
            <p>
              My strength is translating complex topics into practical next steps
              for different stakeholders such as marketing, product, leadership
              and technical teams. I’m known for reliability, clear communication
              and a constructive working climate in complex team settings.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-6">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <Card title="Clarity for every stakeholder">
              I break down complex analytics and SEO topics so decision-makers,
              marketers and technical teams share the same understanding and can
              move forward quickly.
            </Card>
            <Card title="Dependable execution">
              From setup to QA and documentation, I work with a structured
              approach so your tracking, reporting and recommendations remain
              stable and maintainable over time.
            </Card>
            <Card title="Collaboration on eye level">
              I value respectful communication and partnership so your team stays
              enabled and the work stays transparent.
            </Card>
          </div>
        </section>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="flex h-full flex-col rounded-2xl border border-neutral-200 bg-white p-6">
              <div>
                ...
                <p className="mt-3 leading-relaxed text-neutral-700">
                  I help you build a reliable measurement foundation that is
                  privacy-aware, well documented and aligned with your business
                  goals.
                </p>
                ...
                <ul className="mt-4 list-disc space-y-1 pl-6 text-neutral-700">
                  ...
                  <li>
                    Employee training and enablement for Web Analytics best
                    practices
                  </li>
                </ul>
              </div>
              ...
              <div className="mt-auto pt-6">
                <PrimaryButton href="/web-analytics">
                  View Web Analytics
                </PrimaryButton>
              </div>
            </div>
            ...
            <div className="flex h-full flex-col rounded-2xl border border-neutral-200 bg-white p-6">
              <div>
                ...
                <p className="mt-3 leading-relaxed text-neutral-700">
                  I help organisations build sustainable SEO growth through clear
                  strategy, hands-on training and tight integration between
                ...
                <ul className="mt-4 list-disc space-y-1 pl-6 text-neutral-700">
                  ...
                  <li>
                    Technical SEO audits translated into actionable business
                    decisions
                  </li>
              ...
              <div className="mt-auto pt-6">
                <PrimaryButton href="/seo-consulting">
                  View SEO Consulting
                </PrimaryButton>
              </div>
            </div>
        ...
        <section className="max-w-3xl space-y-6">
          ...
          <p className="leading-relaxed text-neutral-700">
            I publish practical insights on LinkedIn and sometimes in-depth
            articles on analytics, SEO and privacy-aware measurement.
          </p>
          <div>
            <SecondaryLink href="/publications">Go to My Publications</SecondaryLink>
          </div>
        </section>
      </div>
    </>
